        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {communityEvents.map((event, i) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="bg-white border border-gray-200 p-8 rounded-3xl hover:shadow-[0_12px_40px_rgb(225,29,72,0.08)] hover:border-rose-300 transition-all flex gap-6 items-start group"
            >
              <div className="w-14 h-14 rounded-2xl bg-rose-50 text-rose-600 flex items-center justify-center shrink-0 border border-rose-100 group-hover:scale-110 transition-transform">
              ...
              <div>
                ...
                <div className="inline-flex items-center gap-2 text-sm font-bold text-rose-600 hover:text-rose-800 cursor-pointer transition-colors bg-rose-50 px-4 py-2 rounded-lg">
